...
pub struct HsxInterconnectMetrics {
...
impl From<super::qpi_common::QpiMetrics> for HsxInterconnectMetrics {
...
#[derive(Debug)]
pub struct HsxInterconnectCollector {
    inner: super::qpi_common::QpiCollector,
}

impl HsxInterconnectCollector {
    ...
    pub async fn sample(&mut self, interval: Duration) -> Result<HsxInterconnectMetrics, String> {
